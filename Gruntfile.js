...
var createFolderGlobs = function(fileTypePatterns) {
  ...
  var ignore = ['node_modules','vendor','dist','temp','test', 'hooks', 'docs', 'coverage'];
  var fs = require('fs');
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
      ...
      main: {
        files: [
          ...
          {src: ['vendor/font-awesome/fonts/**'], dest: 'dist/',filter:'isFile',expand:true},
           {src: ['vendor/bootstrap/fonts/**'], dest: 'dist/',filter:'isFile',expand:true}
    ...
    ngdocs: {
            all: [createFolderGlobs('*.js'),'app/*.js']
    },
    uglify: {
      main: {
        src: 'temp/app.full.js',
  ...
  grunt.registerTask('build', ['jshint', 'clean:before', 'less', 'dom_munger', 'ngtemplates', 'cssmin', 'concat', 'ngAnnotate', 'uglify', 'copy', 'htmlmin', 'clean:after','connect:build','watch']);
  grunt.registerTask('run', ['dom_munger:read', 'jshint', 'connect:dev', 'ngdocs','githooks', 'watch']);
